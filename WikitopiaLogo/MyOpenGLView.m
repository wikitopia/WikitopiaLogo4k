...
const GLfloat colors[] = {
    ...
    0.216, 0.859, 0.290, 1.0,
    0.627, 0.941, 0.980, 1.0,
    0.369, 0.369, 0.369, 1.0,
    0.749, 0.749, 0.749, 1.0,
    1.000, 1.000, 1.000, 1.0
    */
    //Use darker colors, since everything appears a bit washed out in video (codec issue?)
    1.000, 1.000, 1.000, 1.0,
    0.114, 0.841, 0.198, 1.0,
    0.525, 0.925, 0.975, 1.0,
    0.258 ,0.258, 0.258, 1.0,
    0.659, 0.659, 0.659, 1.0,
    1.000, 1.000, 1.000, 1.0
};
